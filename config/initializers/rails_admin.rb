# RailsAdmin config file. Generated on July 05, 2013 17:30
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Todoable', 'Admin']
  ...
  # config.excluded_models = ['Participation', 'Project', 'Role', 'Status', 'Tag', 'Todo', 'User']

  # Include specific models (exclude the others):
  config.included_models = ['Participation', 'Project', 'Role', 'Status', 'Tag', 'Todo', 'User', 'Location', 'Picture']
  ...
  #     configure :todo, :belongs_to_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :todo_id, :integer         # Hidden 
  ...
  #     configure :participations, :has_many_association 
  #     configure :statuses, :has_many_association 
  #     configure :joinups, :has_many_association 
